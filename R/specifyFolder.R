...
specifyFolder <- function(project, assay, plate_folder) {

  files <- list.files(here::here(paste0("data/", project, "/", assay, "/", plate_folder)))
  ...
  plate_map <- paste0(here::here(),"/data/", project, "/", assay, "/", plate_folder, "/", files[plate_map])
  quantstudio <- paste0(here::here(),"/data/", project, "/", assay, "/", plate_folder, "/", files[quantstudio])
